...
-   **STATUS**: "clean" if overall score 8+ AND 0 unresolved; otherwise "issues\_open"
    
-   **overall\_score**: final overall design score (0-10)
    
-   **unresolved**: number of unresolved design decisions
    
-   **decisions\_made**: number of design decisions added to the plan
