...
If the user chooses A: tell Codex to read the plan file itself (avoids ARG\_MAX limits for large plans):
...
-   **critical\_gaps**: number from "Failure modes: \_\_\_ critical gaps flagged"
    
-   **MODE**: FULL\_REVIEW / SCOPE\_REDUCED
