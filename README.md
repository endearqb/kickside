...
- Compact assistant settings with app self-update, install/upgrade, Explorer integration, read-only authentication/API health, Kimi Code Web settings guidance, default work directory, and IM channels
