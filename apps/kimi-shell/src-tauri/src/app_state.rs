...
pub struct RuntimeState {
    ...
    pub workspace_bootstrap_worker_generation: Option<u64>,
    ...
    pub provider_api_health: Option<crate::types::ProviderApiHealth>,
    pub kimi_code_auth_state: Option<KimiCodeAuthState>,
...
impl Default for RuntimeState {
    fn default() -> Self {
        Self {
            ...
            workspace_bootstrap_worker_generation: None,
            ...
            provider_api_health: None,
            kimi_code_auth_state: None,
            kimi_code_auth_message: None,
